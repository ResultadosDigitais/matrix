...
OfficeEvents.prototype.callUserForMyRoom = function callUserForMyRoom(userId, roomId) {
  this.emitEvent('get-user-to-room', { room: roomId, user: userId });
};

OfficeEvents.prototype.onParticipantJoined = function onParticipantJoined(callback) {
  this.listenEvent('enter-room', callback);
};

OfficeEvents.prototype.onParticipantStartedMeet = function onParticipantStartedMeet(callback) {
  this.listenEvent('start-meet', callback);
};

OfficeEvents.prototype.onParticipantLeftMeet = function onParticipantLeftMeet(callback) {
...
OfficeEvents.prototype.onParticipantIsCalled = function onParticipantIsCalled(callback) {
